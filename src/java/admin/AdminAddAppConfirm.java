...
public class AdminAddAppConfirm extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            DataBeans addAppData = new DataBeans();
            ArrayList<DataBeans> searchResult = (ArrayList) hs.getAttribute("searchResult");
            addAppData = searchResult.get(Integer.parseInt(request.getParameter("appNum")));          
